...
<table class="wp-list-table widefat striped">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="<?php echo Utility::build_url( Router::ACTION_CRAWLER, Crawler::TYPE_BLACKLIST_ADD, false, null, array( 'id' => $v[ 'id' ] ) ); ?>" class="button button-secondary"><?php echo __( 'Add to disallowed list', 'litespeed-cache' ); ?></a>
			</td>
		</tr>
		<?php endforeach; ?>
	</tbody>
...
<p>
	...
	<i class="litespeed-dot litespeed-bg-danger"></i> = <?php echo __( 'Disallowed list', 'litespeed-cache' ); ?><br>
</p>
	...
	<tr>
		...
		<td>
			...
			<div class="litespeed-desc">
				...
				<br />💡: <?php echo sprintf(__('Changes to this setting do not apply to already-generated LQIPs. To regenerate existing LQIPs, please %s first from the admin bar menu.', 'litespeed-cache'),'<code>Purge All - LQIP Cache</code>'); ?>
			</div>
		</td>
	</tr>

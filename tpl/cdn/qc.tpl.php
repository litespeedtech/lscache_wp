		...
		<div class="litespeed-column-left-inside">
			...
			<?php if (!$__cloud->activated()) : ?>
				<div class="litespeed-dashboard-unlock litespeed-dashboard-unlock--inline">
					<div>
						...
						<p><a class="button button-primary" href="<?php echo Utility::build_url(Router::ACTION_CLOUD, Cloud::TYPE_ACTIVATE); ?>"><span class="dashicons dashicons-yes"></span><?php echo __('Enable QUIC.cloud services', 'litespeed-cache'); ?></a></p>
			...
			<?php if ($__cloud->activated()) : ?>
				<div class="litespeed-column-with-boxes-footer">
					<a href="<?php echo Utility::build_url(Router::ACTION_CLOUD, Cloud::TYPE_RESET); ?>" class="litespeed-right litespeed-danger" data-litespeed-cfm="<?php echo __( 'Are you sure you want to disconnect from QUIC.cloud? This will not remove any data from the QUIC.cloud dashboard.', 'litespeed-cache' ) ; ?>"><?php echo __('Disconnect from QUIC.cloud', 'litespeed-cache'); ?></a>
					<div class="clear"></div>
				</div>
			<?php endif; ?>

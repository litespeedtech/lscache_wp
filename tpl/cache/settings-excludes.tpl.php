		...
		<tr>
			...
			<td>
				...
				<div class="litespeed-desc">
					...
					<?php printf( __( 'For example, for %1$s, %2$s and %3$s can be used here.', 'litespeed-cache' ), '<code>?aa=bb&cc=dd</code>', '<code>aa</code>', '<code>cc</code>' ); ?>
		...
		<tr>
			...
			<td>
				...
				<div class="litespeed-desc">
					...
					<?php printf( __( 'To prevent %s from being cached, enter them here.', 'litespeed-cache' ), __( 'categories', 'litespeed-cache' ) ); ?>
					<?php Doc::one_per_line(); ?>
				</div>
		...
		<tr>
			...
			<td>
				...
				<div class="litespeed-desc">
					...
					<?php printf( __( 'To prevent %s from being cached, enter them here.', 'litespeed-cache' ), __( 'tags', 'litespeed-cache' ) ); ?>
					<?php Doc::one_per_line(); ?>
				</div>
				<div class="litespeed-callout notice notice-warning inline">
					<h4><?php echo __( 'NOTE', 'litespeed-cache' ); ?>:</h4>

...
<table class="wp-list-table striped litespeed-table"><tbody>
	...
	<tr>
		...
		<td>
				...
				<div class="litespeed-width-3-10">
					<p class="litespeed-desc">
						...
						<br /><font class="litespeed-success">
							...
							<?php printf( __( 'Filter %s is supported.', 'litespeed-cache' ), '<code>litespeed_esi_nonces</code>' ); ?>
						</font>
					</p>
				</div>
			</div>
			...
			<div class="litespeed-desc">
				<?php printf( __( 'Wildcard %1$s supported (match zero or more characters). For example, to match %2$s and %3$s, use %4$s.', 'litespeed-cache' ), '<code>*</code>', '<code>nonce_formid_1</code>', '<code>nonce_formid_3</code>', '<code>nonce_formid_*</code>' ); ?>
			</div>
		</td>
	</tr>

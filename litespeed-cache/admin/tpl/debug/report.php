...
<h3 class="litespeed-title"><?php echo __('Report', 'litespeed-cache'); ?></h3>
...
<div class="litespeed-panel-wrapper">
	...
	<a href="<?php echo LiteSpeed_Cache_Utility::build_url( LiteSpeed_Cache::ACTION_REPORT, LiteSpeed_Cache_Report::TYPE_SEND_REPORT ) ; ?>" class="litespeed-btn-warning">

...
<table class="form-table"><tbody>
	...
	<tr>
		...
		<td>
			...
			?>
			<textarea name="<?php echo LiteSpeed_Cache_Config::OPTION_NAME; ?>[<?php echo $id; ?>]" rows="5" cols="80"><?php echo esc_textarea($_options[$id]); ?></textarea>
		...
		<td>
			...
			<div class="litespeed-row">
				<div class="litespeed-switch litespeed-label-info">
					...
					<input type="radio" name="<?php echo LiteSpeed_Cache_Config::OPTION_NAME; ?>[<?php echo $id; ?>]" id="conf_<?php echo $id; ?>_1" value="<?php echo $val; ?>" <?php echo $_options[$id]==$val?'checked':''; ?> />
					...
					<input type="radio" name="<?php echo LiteSpeed_Cache_Config::OPTION_NAME; ?>[<?php echo $id; ?>]" id="conf_<?php echo $id; ?>_2" value="<?php echo $val; ?>" <?php echo $_options[$id]==$val?'checked':''; ?> />
					...
					<input type="radio" name="<?php echo LiteSpeed_Cache_Config::OPTION_NAME; ?>[<?php echo $id; ?>]" id="conf_<?php echo $id; ?>_3" value="<?php echo $val; ?>" <?php echo $_options[$id]==$val?'checked':''; ?> />
	...
	<tr>
		...
		<td>
			...
			<input type="text" class="regular-text" name="<?php echo LiteSpeed_Cache_Config::OPTION_NAME; ?>[<?php echo $id; ?>]" value="<?php echo esc_textarea($_options[$id]); ?>" /> <?php echo __('microseconds', 'litespeed-cache'); ?>
			<div class="litespeed-desc">
	...
	<tr>
		...
		<td>
			...
			<input type="text" class="regular-text" name="<?php echo LiteSpeed_Cache_Config::OPTION_NAME; ?>[<?php echo $id; ?>]" value="<?php echo esc_textarea($_options[$id]); ?>" /> <?php echo __('seconds', 'litespeed-cache'); ?>
			<div class="litespeed-desc">

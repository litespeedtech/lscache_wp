...
LiteSpeed_API::hook_init( 'LiteSpeed_Cache_ThirdParty_Divi_Theme_Builder::pre_load' ) ;
LiteSpeed_API::register( 'LiteSpeed_Cache_ThirdParty_Divi_Theme_Builder' ) ;
...
class LiteSpeed_Cache_ThirdParty_Divi_Theme_Builder
{
	...
	public static function pre_load()
	{
		...
		if ( ! empty( $_GET[ 'et_fb' ] ) ) {
			LiteSpeed_API::disable_all( 'divi edit mode' ) ;
		}
	}
	...
	public static function detect()
	{
		 ...
		 */
		LiteSpeed_API::nonce_action( 'et-pb-contact-form-submit' ) ;
		...
		add_filter( 'litespeed_sub_esi_params-comment-form', 'LiteSpeed_Cache_ThirdParty_Divi_Theme_Builder::esi_comment_add_slash' ) ;
		*/
	}

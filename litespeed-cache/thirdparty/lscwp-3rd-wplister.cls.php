...
class LiteSpeed_Cache_ThirdParty_WPLister
{
	...
	public static function detect()
	{
		if ( defined('WOOCOMMERCE_VERSION') && defined('WPLISTER_VERSION') ) {
			...
			add_action('wplister_revise_inventory_status', [ LiteSpeed_Cache_ThirdParty_WooCommerce::get_instance(), 'backend_purge' ] ) ;
			// Added as a safety measure for WPLister Pro only.
			add_action('wplister_inventory_status_changed', [ LiteSpeed_Cache_ThirdParty_WooCommerce::get_instance(), 'backend_purge' ] ) ;
		}
	}

...
// error_log("oc: flush " ) ;
	 ...
	 * @since 1.8.3
	 * @access private
	 * @see `wp-includes/option.php` function `get_transient`
	 */
	 ...
	 * @since 1.8.3
	 * @access private
	 * @see `wp-includes/option.php` function `set_transient`
	 */
	 ...
	 * @since 1.8.3
	 * @access private
	 * @see `wp-includes/option.php` function `delete_transient`
	 */

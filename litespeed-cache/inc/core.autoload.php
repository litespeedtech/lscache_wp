...
if ( !function_exists('_litespeed_autoload') ) {
	function _litespeed_autoload($cls)
	{
		$class2fileArr = array(
			...
			'LiteSpeed_Activation'		=> 'inc/activation.cls.php',
			'LiteSpeed_API'				=> 'inc/api.cls.php',
			'LiteSpeed_Avatar'			=> 'inc/avatar.cls.php',
			'LiteSpeed_CDN'				=> 'inc/cdn.cls.php',
			'LiteSpeed_CDN_Cloudflare'	=> 'inc/cdn/cloudflare.cls.php',
			'LiteSpeed_CDN_Quic'			=> 'inc/cdn/quic.cls.php',
			'LiteSpeed_Config'			=> 'inc/config.cls.php',
			...
			'LiteSpeed_Media'				=> 'inc/media.cls.php',

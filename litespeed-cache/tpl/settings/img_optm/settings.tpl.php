...
<table class="wp-list-table striped litespeed-table"><tbody>
	...
	<tr>
		<th>
			<?php $id = Const::O_IMG_OPTM_RM_BKUP ; ?>
			<?php $this->title( $id ) ; ?>
		</th>
		<td>
			<?php $this->build_switch( $id ) ; ?>
	...
	<tr>
		<th>
			<?php $id = Const::O_IMG_OPTM_LOSSLESS ; ?>
			<?php $this->title( $id ) ; ?>
		</th>
		<td>
			<?php $this->build_switch( $id ) ; ?>
	...
	<?php
		if ( ! is_multisite() ) :
			// webp
			require LSCWP_DIR . 'tpl/settings/img_optm/settings.media_webp.tpl.php' ;
	...
	<tr>
		<th>
			<?php $id = Const::O_IMG_OPTM_WEBP_ATTR ; ?>
			<?php $this->title( $id ) ; ?>
		</th>
		<td>
	...
	<tr>
		<th>
			<?php $id = Const::O_IMG_OPTM_WEBP_REPLACE_SRCSET ; ?>
			<?php $this->title( $id ) ; ?>
		</th>
		<td>
			<?php $this->build_switch( $id ) ; ?>
	...
	<tr>
		<th>
			<?php $id = Const::O_IMG_OPTM_JPG_QUALITY ; ?>
			<?php $this->title( $id ) ; ?>
		</th>
		<td>

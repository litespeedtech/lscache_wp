...
<table class="wp-list-table striped litespeed-table"><tbody>
	<tr>
		...
		<td>
			<?php $this->build_switch(LiteSpeed_Config::NETWORK_O_ENABLED); ?>
	...
	<tr>
		...
		<td>
			<?php $this->build_switch(LiteSpeed_Config::NETWORK_O_USE_PRIMARY); ?>
			<div class="litespeed-desc">
	...
	<?php require LSCWP_DIR . 'tpl/settings/setting/settings_inc.auto_upgrade.php' ; ?>

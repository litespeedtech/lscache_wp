...
<div class="litespeed-wrap">
	...
	require LSCWP_DIR . "tpl/settings/inc/check_if_network_disable_all.php" ;
	require LSCWP_DIR . "tpl/settings/cache/more_settings_tip.tpl.php" ;

	// include all tpl for faster UE
	foreach ( $menu_list as $tab => $val ) {
		echo "<div data-litespeed-layout='$tab'>" ;
		require LSCWP_DIR . "tpl/settings/cache/settings-$tab.tpl.php" ;
		echo "</div>" ;
	}

...
<table class="wp-list-table striped litespeed-table"><tbody>
	...
	<?php
		if ( ! is_multisite() ) :
			require LSCWP_DIR . 'tpl/settings/cache/settings_inc.cache_favicon.tpl.php' ;
			require LSCWP_DIR . 'tpl/settings/cache/settings_inc.cache_resources.tpl.php' ;
			require LSCWP_DIR . 'tpl/settings/cache/settings_inc.cache_mobile.tpl.php' ;
		endif ;
	?>

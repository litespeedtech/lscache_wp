...
<form method="post" action="admin.php" id="litespeed_form_quic" class="litespeed-relative">
	...
	<div class="litespeed-row">
		...
		<input type="text" name="email" value="<?php echo LiteSpeed_Cache::config( LiteSpeed_Config::O_CDN_QUIC_EMAIL ) ; ?>" class="regular-text litespeed-input-large" required placeholder="<?php echo __( 'Email', 'litespeed-cache' ) ; ?>" />
	</div>

...
<table class="wp-list-table striped litespeed-table"><tbody>
	...
	<?php require LSCWP_DIR . 'tpl/setting/settings_inc.cache_favicon.php' ; ?>
	<?php require LSCWP_DIR . 'tpl/setting/settings_inc.cache_resources.php' ; ?>
	<?php require LSCWP_DIR . 'tpl/setting/settings_inc.cache_mobile.php' ; ?>

...
class Doc {
	...
	public static function notice_ips() {
		...
		echo '⚠️ ' . sprintf( __( 'For online services to work correctly, you must list all allowed %s server IPs.', 'litespeed-cache' ), 'QUIC.cloud' ) . '<br/>';
		echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . __( 'Before generating key, please verify all IPs on this list are listed as allowed', 'litespeed-cache' ) . ': ';

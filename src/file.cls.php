...
class File {
	...
	/**
	 * Whitelist .htaccess seeded into LITESPEED_STATIC_DIR. Anything not explicitly allowed returns 403.
	 *
	 * @since 7.9
	 */
	const STATIC_DIR_HTACCESS = <<<HTACCESS
# BEGIN LSCACHE_STATIC_PROTECT
...
<IfModule mod_rewrite.c>
    ...
    # Whitelisted public asset folders
    RewriteRule ^(css|js|ucss|ccss|lqip|optimax|avatar|localres|crawler)(/|$) - [L]

    # Default deny
    RewriteRule .* - [F,L]
</IfModule>
# END LSCACHE_STATIC_PROTECT
HTACCESS;

	/**
	 * Seed .htaccess + robots.txt into LITESPEED_STATIC_DIR if missing
	 *
	 * @since 7.9
	 */
	public static function ensure_static_protection() {
		...
		$bytes = @file_put_contents($htaccess_path, self::STATIC_DIR_HTACCESS, LOCK_EX);
		...
		if ($bytes === strlen(self::STATIC_DIR_HTACCESS)) {

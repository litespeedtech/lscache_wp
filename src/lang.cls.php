...
class Lang extends Base {
	...
	public static function title( $id ) {
		$_lang_list = [
			...
			self::CDN_MAPPING_INC_DOCS    => __( 'Include Docs', 'litespeed-cache' ),
			self::CDN_MAPPING_INC_FONTS   => __( 'Include Fonts', 'litespeed-cache' ),
			self::CDN_MAPPING_INC_MEDIA   => __( 'Include Media', 'litespeed-cache' ),

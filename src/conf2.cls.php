...
class Conf2 extends Trunk {
	 ...
	 * Save option
	 *
	 * Note: this is direct save, won't trigger corresponding file update or data sync. To save settings normally, always use `Conf2->update_confs()`
	 *
	 * @since  3.0
	 * @access public
	 */
